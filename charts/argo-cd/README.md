...
![Version: 2.8.0-ak.0.0](https://img.shields.io/badge/Version-2.8.0--ak.0.0-informational?style=flat-square) ![AppVersion: 2.8.0](https://img.shields.io/badge/AppVersion-2.8.0-informational?style=flat-square)
...
| redis | object | `{"enabled":true,"haProxyImage":{"repository":"haproxy","tag":"2.6.14-alpine"},"image":{"pullPolicy":null,"repository":"quay.io/akuity/redis","tag":"7.0.11-alpine"},"resources":null}` | Redis configurations |
