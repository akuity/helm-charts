...
|-----|------|---------|-------------|
| applicationsetController | object | `{"enabled":false,"image":{"pullPolicy":null,"repository":"quay.io/argoproj/argocd-applicationset","tag":"v0.4.0"},"serviceMonitor":{"enabled":false}}` | ApplicationSet Controller |
| applicationsetController.enabled | bool | `false` | Whether to enable ApplicationSet Controller |
| applicationsetController.serviceMonitor | object | `{"enabled":false}` | Enable service monitor |
...
| controller.serviceMonitor | object | `{"enabled":false}` | Enable service monitor |
...
| repoServer | object | `{"extraArgs":null,"image":{"pullPolicy":null,"repository":null,"tag":null},"replicas":2,"resources":null,"serviceMonitor":{"enabled":false}}` | Repo Server |
| repoServer.extraArgs | string | `nil` | Additional command line arguments to pass to argocd-repo-server |
| repoServer.serviceMonitor | object | `{"enabled":false}` | Enable service monitor |
| server | object | `{"enabled":true,"extraArgs":null,"image":{"pullPolicy":null,"repository":null,"tag":null},"ingress":{"annotations":{},"className":"","enabled":false,"host":"argocd.example.com","tls":{"enabled":false,"secretName":null}},"insecure":false,"replicas":2,"resources":null,"service":{"type":null},"serviceMonitor":{"enabled":false}}` | Argo Server configuration |
...
| server.serviceMonitor | object | `{"enabled":false}` | Enable service monitor |
